        ...
        return (
          this.each(function() {
            ...
            function e(a, b, c) {
              ...
              if (
                (b &&
                  ((e =
                    parseInt(z.css("top")) +
                    ((a * parseInt(d.wheelStep)) / 100) * z.outerHeight()),
                  (e = Math.min(Math.max(e, 0), f)),
                  (e = a > 0 ? Math.ceil(e) : Math.floor(e)),
                  z.css({ top: e + "px" })),
                (o =
                  parseInt(z.css("top")) / (u.outerHeight() - z.outerHeight())),
                (e = o * (u[0].scrollHeight - u.outerHeight())),
                c)
              ) {
                e = a;
                var i = (e / u[0].scrollHeight) * u.outerHeight();
                (i = Math.min(Math.max(i, 0), f)), z.css({ top: i + "px" });
              }
            ...
            function g() {
              ...
              z.stop(!0, !0).fadeIn("fast"),
                d.railVisible && y.stop(!0, !0).fadeIn("fast");
            }
            function h() {
              d.alwaysVisible ||
            ...
            if (u.parent().hasClass(d.wrapperClass)) {
              var v = u.scrollTop();
              if (
                ((z = u.closest("." + d.barClass)),
                (y = u.closest("." + d.railClass)),
                f(),
                a.isPlainObject(b))
              ) {
                ...
                if ("scrollTo" in b) v = parseInt(d.scrollTo);
                  ...
                  return z.remove(), y.remove(), void u.unwrap();
                e(v, !1, !0);
              }
              ...
              u.css({ overflow: "hidden", width: d.width, height: d.height });
              var y = a(q)
                  ...
                  .css({
                    ...
                    top: 0,
                    display:
                      d.alwaysVisible && d.railVisible ? "block" : "none",
              ...
              y.css(A),
                ...
                d.railDraggable &&
                  z
                    .bind("mousedown", function(b) {
                      ...
                      return (
                        (k = !0),
                        (t = parseFloat(z.css("top"))),
                        (pageY = b.pageY),
                        c.bind("mousemove.slimscroll", function(a) {
                          (currTop = t + a.pageY - pageY),
                            z.css("top", currTop),
                            e(0, z.position().top, !1);
                        }),
                ...
                u.bind("touchmove", function(a) {
                  if (
                    (s || a.originalEvent.preventDefault(),
                    a.originalEvent.touches.length)
                  ) {
                    e(
                      (m - a.originalEvent.touches[0].pageY) /
                ...
                f(),
                "bottom" === d.start
                  ? (z.css({ top: u.outerHeight() - z.outerHeight() }),
                    e(0, !0))
                  : "top" !== d.start &&
                    (e(a(d.start).position().top, null, !0),
                    d.alwaysVisible || z.hide()),
                (function(a) {
                  window.addEventListener
                    ? (a.addEventListener("DOMMouseScroll", c, !1),
                      a.addEventListener("mousewheel", c, !1))
  ...
  (function(a, b) {
    ...
    function i(a) {
      ...
      for (
        ...
        if (
          c.classList.contains("waves-effect") &&
    ...
    return (
      ...
      (k.ripple = function(a, b) {
        ...
        if (
          ...
          for (
            var d, g, h, i = {}, j = 0, k = { type: "mousedown", button: 1 };
            j < c;
            j++
          )
            if (
    ...
    !(function(a) {
      ...
      (d = function() {
            ...
            return this.format.replace(this.fre, function() {
              ...
              return (
                ...
                void 0 === (g = j[e])
                  ? ""
                  : f && b && b[f]
                  ? ((a = b[f]), a.get ? b[f].get(g) || g : b[f][g] || g)
                  : (l(g) &&
                      (g = c.get("numberFormatter")
                        ? c.get("numberFormatter")(g)
                        : p(
                            g,
                            h,
                            c.get("numberDigitGroupCount"),
                            c.get("numberDigitGroupSep"),
                            c.get("numberDecimalMark")
                          )),
                    g)
              );
            });
        ...
        (p = function(a, b, d, e, f) {
          var g, h;
          for (
            a = (!1 === b ? parseFloat(a).toString() : a.toFixed(b)).split(""),
              g = (g = c.inArray(".", a)) < 0 ? a.length : g,
              g < a.length && (a[g] = f),
              h = g - d;
            h > 0;
            h -= d
        ...
        (n = function(b) {
          ...
          (c = a.createElement("style")),
            ...
            d
              ? (a.styleSheets[a.styleSheets.length - 1].cssText = b)
              : (c[
        ...
        (c.fn.simpledraw = function(b, d, e, f) {
          ...
          if (void 0 === c.fn.sparkline.canvas) {
            ...
            if (i.getContext && i.getContext("2d"))
              c.fn.sparkline.canvas = function(a, b, c, d) {
                return new F(a, b, c, d);
              };
            else {
              if (!a.namespaces || a.namespaces.v)
                return (c.fn.sparkline.canvas = !1), !1;
              a.namespaces.add(
                "v",
          ...
          return (
            void 0 === b && (b = c(this).innerWidth()),
            void 0 === d && (d = c(this).innerHeight()),
            (g = c.fn.sparkline.canvas(b, d, this, f)),
            (h = c(this).data("_jqs_mhandler")),
            h && h.registerCanvas(g),
            g
          );
        }),
        ...
        (r = e({
          ...
          registerCanvas: function(a) {
            ...
            (this.canvas = a),
              (this.$canvas = b),
              b.mouseenter(c.proxy(this.mouseenter, this)),
              b.mouseleave(c.proxy(this.mouseleave, this)),
          ...
          reset: function(a) {
            (this.splist = []),
              this.tooltip &&
                a &&
                (this.tooltip.remove(), (this.tooltip = void 0));
          },
          ...
          mouseenter: function(b) {
            c(a.body).unbind("mousemove.jqs"),
              c(a.body).bind("mousemove.jqs", c.proxy(this.mousemove, this)),
              (this.over = !0),
          ...
          mouseleave: function() {
            ...
            for (
              ...
              (b = e[d]), b.clearRegionHighlight() && (g = !0);
          ...
          updateDisplay: function() {
            ...
            if (this.over) {
              for (d = 0; d < h; d++)
                (b = g[d]),
                  (e = b.setRegionHighlight(this.currentEl, k, l)) && (i = !0);
              if (i) {
                if (
                  ((f = c.Event("sparklineRegionChange")),
                  (f.sparklines = this.splist),
                  this.$el.trigger(f),
                  this.tooltip)
                ) {
                  for (a = "", d = 0; d < h; d++)
                    (b = g[d]), (a += b.getCurrentRegionTooltip());
        ...
        (s = e({
          ...
          init: function(b) {
            ...
            (this.container = b.get("tooltipContainer") || a.body),
              ...
              (d = this.tooltip.offset()),
              (this.offsetLeft = d.left),
              (this.offsetTop = d.top),
              (this.hidden = !0),
              c(window).unbind("resize.jqs scroll.jqs"),
              c(window).bind(
                "resize.jqs scroll.jqs",
                c.proxy(this.updateWindowDims, this)
              ),
              this.updateWindowDims();
          },
          updateWindowDims: function() {
            (this.scrollTop = c(window).scrollTop()),
              (this.scrollLeft = c(window).scrollLeft()),
              (this.scrollRight = this.scrollLeft + c(window).width()),
              this.updatePosition();
          },
          getSize: function(a) {
          ...
          remove: function() {
            this.tooltip.remove(),
              this.sizetip.remove(),
              (this.sizetip = this.tooltip = void 0),
              c(window).unbind("resize.jqs scroll.jqs");
          }
        })),
        (C = function() {
        ...
        c(C),
        (H = []),
        (c.fn.sparkline = function(b, d) {
          return this.each(function() {
            var e,
              f,
              g = new c.fn.sparkline.options(this, d),
              h = c(this);
            if (
              ((e = function() {
                var d, e, f, i, j, k, l;
                if (
                  ("html" === b || void 0 === b
                    ? ((l = this.getAttribute(g.get("tagValuesAttribute"))),
                      (void 0 !== l && null !== l) || (l = h.html()),
                      (d = l
                        .replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "")
                        .split(",")))
                    : (d = b),
                  (e =
                    "auto" === g.get("width")
                      ? d.length * g.get("defaultPixelsPerValue")
                      : g.get("width")),
                  "auto" === g.get("height")
                    ? (g.get("composite") && c.data(this, "_jqs_vcanvas")) ||
                      ((i = a.createElement("span")),
                      (i.innerHTML = "a"),
                      h.html(i),
                      (f = c(i).innerHeight() || c(i).height()),
                      c(i).remove(),
                      (i = null))
                    : (f = g.get("height")),
                  g.get("disableInteraction")
                    ? (j = !1)
                    : ((j = c.data(this, "_jqs_mhandler")),
                      j
                        ? g.get("composite") || j.reset()
                        : ((j = new r(this, g)),
                          c.data(this, "_jqs_mhandler", j))),
                  g.get("composite") && !c.data(this, "_jqs_vcanvas"))
                )
                  return void (
                    c.data(this, "_jqs_errnotify") ||
                    (alert(
                      "Attempted to attach a composite sparkline to an element with no existing sparkline"
                    ),
                    c.data(this, "_jqs_errnotify", !0))
                  );
                (k = new c.fn.sparkline[g.get("type")](this, d, g, e, f)),
                  k.render(),
                  j && j.registerSparkline(k);
              }),
              (c(this).html() &&
                !g.get("disableHiddenCheck") &&
                c(this).is(":hidden")) ||
                !c(this).parents("body").length)
            ) {
              if (!g.get("composite") && c.data(this, "_jqs_pending"))
                for (f = H.length; f; f--)
                  H[f - 1][0] == this && H.splice(f - 1, 1);
              H.push([this, e]), c.data(this, "_jqs_pending", !0);
            } else e.call(this);
          });
        }),
        (c.fn.sparkline.defaults = d()),
        (c.sparkline_display_visible = function() {
          var a,
            b,
            d,
            e = [];
          for (b = 0, d = H.length; b < d; b++)
            (a = H[b][0]),
              ...
              !c(a)
                ...
                .is(":hidden")
                ? (H[b][1].call(a),
                  c.data(H[b][0], "_jqs_pending", !1),
                  e.push(b))
                : c(a).closest("html").length ||
                  c.data(a, "_jqs_pending") ||
                  (c.data(H[b][0], "_jqs_pending", !1), e.push(b));
        ...
        (c.fn.sparkline.options = e({
          init: function(a, b) {
            ...
            (this.userOptions = b = b || {}),
              (this.tag = a),
              (this.tagValCache = {}),
              (e = c.fn.sparkline.defaults),
              (f = e.common),
              (this.tagOptionsPrefix =
                b.enableTagOptions &&
                (b.tagOptionsPrefix || f.tagOptionsPrefix)),
              (g = this.getTagSetting("type")),
              (d = g === I ? e[b.type || f.type] : e[g]),
              (this.mergedOptions = c.extend({}, f, d, b));
          },
          getTagSetting: function(a) {
            var b,
              ...
              d,
              e,
              f = this.tagOptionsPrefix;
            if (!1 === f || void 0 === f) return I;
            if (this.tagValCache.hasOwnProperty(a)) b = this.tagValCache.key;
            else {
              if (void 0 === (b = this.tag.getAttribute(f + a)) || null === b)
                b = I;
              else if ("[" === b.substr(0, 1))
                for (
                  b = b.substr(1, b.length - 2).split(","), c = b.length;
                  c--;

                )
                  b[c] = i(b[c].replace(/(^\s*)|(\s*$)/g, ""));
              else if ("{" === b.substr(0, 1))
                for (
                  d = b.substr(1, b.length - 2).split(","),
                    b = {},
                    c = d.length;
                  c--;
        ...
        (c.fn.sparkline._base = e({
          ...
          setRegionHighlight: function(a, b, c) {
            ...
            return b > this.canvasWidth ||
              ...
              c < 0
              ? null
              : ((d = this.getRegion(a, b, c)),
                e !== d &&
                  (void 0 !== e && f && this.removeHighlight(),
                  (this.currentRegion = d),
                  void 0 !== d && f && this.renderHighlight(),
                  !0));
          },
          clearRegionHighlight: function() {
            return (
              void 0 !== this.currentRegion &&
              (this.removeHighlight(), (this.currentRegion = void 0), !0)
            );
          },
          ...
          getCurrentRegionTooltip: function() {
            ...
            if (
              ...
              (m = q.get("tooltipFormatter")))
            )
              return m(this, q, a);
            if (
              (q.get("tooltipChartTitle") &&
                (r +=
            ...
            if (
              (c.isArray(b) || (b = [b]),
              c.isArray(a) || (a = [a]),
              (i = this.options.get("tooltipFormatFieldlist")),
              (j = this.options.get("tooltipFormatFieldlistKey")),
              i && j)
            ) {
              for (k = [], h = a.length; h--; )
                (l = a[h][j]), -1 != (p = c.inArray(l, i)) && (k[p] = a[h]);
              a = k;
            }
            for (d = b.length, o = a.length, h = 0; h < d; h++)
              for (
                n = b[h],
                  "string" == typeof n && (n = new f(n)),
                  e = n.fclass || "jqsfield",
                  p = 0;
                p < o;
                p++
              )
                (a[p].isNull && q.get("tooltipSkipNull")) ||
                  (c.extend(a[p], {
                    prefix: q.get("tooltipPrefix"),
                    suffix: q.get("tooltipSuffix")
                  }),
                  (g = n.render(a[p], q.get("tooltipValueLookups"), q)),
                  s.push('<div class="' + e + '">' + g + "</div>"));
          ...
          calcHighlightColor: function(a, c) {
            ...
            if (
              ...
              for (f = [], e = 4 === a.length ? 16 : 1, h = 0; h < 3; h++)
                f[h] = g(b.round(parseInt(d[h + 1], 16) * e * j), 0, 255);
              return "rgb(" + f.join(",") + ")";
            }
            return a;
          }
        ...
        (t = {
          changeHighlight: function(a) {
            ...
            f &&
              ((b = this.renderRegion(d, a)),
              c.isArray(b) || c.isArray(f)
                ? (e.replaceWithShapes(f, b),
                  (this.regionShapes[d] = c.map(b, function(a) {
                    return a.id;
                  })))
        ...
        (c.fn.sparkline.line = u = e(c.fn.sparkline._base, {
          ...
          renderHighlight: function() {
            ...
            e &&
              (g &&
                h &&
                ((a = d.drawCircle(e[0], e[1], g, void 0, h)),
                (this.highlightSpotId = a.id),
                d.insertAfterShape(this.lastShapeId, a)),
              i &&
                ((b = d.drawLine(
                  e[0],
                  this.canvasTop,
                ...
                d.insertAfterShape(this.lastShapeId, b)));
          },
          removeHighlight: function() {
            var a = this.target;
            ...
            if (
              ...
              for (
                f = g = 0,
                  ...
                  d = this.maxy - this.miny == 0 ? 1 : this.maxy - this.miny,
                  e = this.yvalues.length - 1,
                  I && (F < 4 * I || G < 4 * I) && (I = 0),
                  I &&
                    ((y =
                      D.get("highlightSpotColor") &&
                      !D.get("disableInteraction")),
                    (y ||
                      D.get("minSpotColor") ||
                      (D.get("spotColor") && B[e] === this.miny)) &&
                      (G -= b.ceil(I)),
                    (y ||
                      D.get("maxSpotColor") ||
                      (D.get("spotColor") && B[e] === this.maxy)) &&
                      ((G -= b.ceil(I)), (f += b.ceil(I))),
                    (y ||
                      ((D.get("minSpotColor") || D.get("maxSpotColor")) &&
                    ...
                    (y ||
                      ...
                      D.get("minSpotColor") ||
                      (D.get("maxSpotColor") &&
                        (B[e] === this.miny || B[e] === this.maxy))) &&
                      (F -= b.ceil(I))),
                  G--,
                  void 0 === D.get("normalRangeMin") ||
                    D.get("drawNormalOnTop") ||
                    this.drawNormalRange(g, f, G, F, d),
                  i = [],
                  j = [i],
                  p = r = null,
                  s = B.length,
                ...
                (k = A[C]),
                  (m = A[C + 1]),
                  (l = B[C]),
                  (n = g + b.round((k - this.minx) * (F / a))),
                  (o = C < s - 1 ? g + b.round((m - this.minx) * (F / a)) : F),
                  (r = n + (o - n) / 2),
                  (J[C] = [p || 0, r, C]),
                  (p = r),
                  null === l
                    ? C &&
                      (null !== B[C - 1] && ((i = []), j.push(i)), H.push(null))
                    : (l < this.miny && (l = this.miny),
                      l > this.maxy && (l = this.maxy),
                      i.length || i.push([n, f + G]),
                      (h = [n, f + b.round(G - G * ((l - this.miny) / d))]),
                      i.push(h),
                      H.push(h));
              for (t = [], v = [], w = j.length, C = 0; C < w; C++)
                (i = j[C]),
                  i.length &&
                    (D.get("fillColor") &&
                      (i.push([i[i.length - 1][0], f + G]),
                      v.push(i.slice(0)),
                      i.pop()),
                    i.length > 2 && (i[0] = [i[0][0], i[1][1]]),
                    t.push(i));
              for (w = v.length, C = 0; C < w; C++)
                E.drawShape(
                  v[C],
                  D.get("fillColor"),
                  D.get("fillColor")
              ...
              if (I && D.get("valueSpots"))
                for (
                  ...
                  (z = x.get(B[C])) &&
                    E.drawCircle(
                      g + b.round((A[C] - this.minx) * (F / a)),
                      f + b.round(G - G * ((B[C] - this.miny) / d)),
                      I,
                      void 0,
                      z
                    ).append();
              I &&
                ...
                null !== B[e] &&
                E.drawCircle(
                  g + b.round((A[A.length - 1] - this.minx) * (F / a)),
                  f + b.round(G - G * ((B[e] - this.miny) / d)),
                  I,
                  void 0,
                  D.get("spotColor")
                ).append(),
                this.maxy !== this.minyorg &&
                  (I &&
                    D.get("minSpotColor") &&
                    ((k = A[c.inArray(this.minyorg, B)]),
                    E.drawCircle(
                      g + b.round((k - this.minx) * (F / a)),
                      f + b.round(G - G * ((this.minyorg - this.miny) / d)),
                      I,
                      void 0,
                      D.get("minSpotColor")
                    ).append()),
                  I &&
                    D.get("maxSpotColor") &&
                    ((k = A[c.inArray(this.maxyorg, B)]),
                    E.drawCircle(
                      g + b.round((k - this.minx) * (F / a)),
                      f + b.round(G - G * ((this.maxyorg - this.miny) / d)),
                      I,
                      void 0,
                      D.get("maxSpotColor")
                    ).append())),
        ...
        (c.fn.sparkline.bar = v = e(c.fn.sparkline._base, t, {
          ...
          init: function(a, d, e, f, h) {
            var l,
              ...
              P = -1 / 0;
            for (
              v._super.init.call(this, a, d, e, f, h), r = 0, s = d.length;
              r < s;
              r++
            )
              (G = d[r]),
                ((l = "string" == typeof G && G.indexOf(":") > -1) ||
                  c.isArray(G)) &&
                  ((B = !0),
                  l && (G = d[r] = j(G.split(":"))),
                  (G = k(G, null)),
            ...
            (this.stacked = B),
              ...
              (this.barWidth = J),
              (this.barSpacing = K),
              (this.totalBarWidth = J + K),
              (this.width = f = d.length * J + (d.length - 1) * K),
              this.initTarget(),
              N &&
                ((z = void 0 === L ? -1 / 0 : L),
                (A = void 0 === M ? 1 / 0 : M)),
            ...
            for (r = 0, s = d.length; r < s; r++)
              if (B)
                ...
                (G = N ? g(d[r], z, A) : d[r]),
                  null !== (G = d[r] = i(G)) && p.push(G);
            (this.max = y = b.max.apply(b, p)),
              (this.min = x = b.min.apply(b, p)),
              (this.stackMax = P = B ? b.max.apply(b, Q) : y),
              (this.stackMin = O = B ? b.min.apply(b, p) : x),
              void 0 !== e.get("chartRangeMin") &&
                (e.get("chartRangeClip") || e.get("chartRangeMin") < x) &&
                (x = e.get("chartRangeMin")),
              void 0 !== e.get("chartRangeMax") &&
                (e.get("chartRangeClip") || e.get("chartRangeMax") > y) &&
                (y = e.get("chartRangeMax")),
              (this.zeroAxis = u = e.get("zeroAxis", !0)),
              (w = x <= 0 && y >= 0 && u ? 0 : 0 == u ? x : x > 0 ? x : y),
              (this.xaxisOffset = w),
              (t = B ? b.max.apply(b, o) + b.max.apply(b, R) : y - x),
              (this.canvasHeightEf =
                u && x < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
              x < w
                ? ((I = B && y >= 0 ? P : y),
                  (H = ((I - w) / t) * this.canvasHeight) !== b.ceil(H) &&
                    ((this.canvasHeightEf -= 2), (H = b.ceil(H))))
                : (H = this.canvasHeight),
              (this.yoffset = H),
              c.isArray(e.get("colorMap"))
                ? ((this.colorMapByIndex = e.get("colorMap")),
                  (this.colorMapByValue = null))
                : ((this.colorMapByIndex = null),
                  (this.colorMapByValue = e.get("colorMap")),
                  this.colorMapByValue &&
                    void 0 === this.colorMapByValue.get &&
          ...
          calcColor: function(a, b, d) {
            ...
            return (
              (e = this.stacked
                ? i.get("stackedBarColor")
                : b < 0
                ? i.get("negBarColor")
                : i.get("barColor")),
              0 === b &&
                void 0 !== i.get("zeroColor") &&
                (e = i.get("zeroColor")),
              h && (f = h.get(b)) ? (e = f) : g && g.length > d && (e = g[d]),
              c.isArray(e) ? e[a % e.length] : e
            );
          },
          renderRegion: function(a, d) {
            ...
            if (
              ...
              return q.get("nullColor")
                ? ((g = d
                    ? q.get("nullColor")
                    : this.calcHighlightColor(q.get("nullColor"), q)),
                  (e = y > 0 ? y - 1 : y),
                  v.drawRect(w, e, this.barWidth - 1, 0, g, g))
                : void 0;
            for (i = y, j = 0; j < k; j++) {
              if (((l = p[j]), u && l === r)) {
                if (!o || n) continue;
              ...
              (f = t > 0 ? b.floor(x * (b.abs(l - r) / t)) + 1 : 1),
                l < r || (l === r && 0 === y)
                  ? ((e = i), (i += f))
                  : ((e = y - f), (y -= f)),
                (g = this.calcColor(j, l, a)),
                d && (g = this.calcHighlightColor(g, q)),
                s.push(v.drawRect(w, e, this.barWidth - 1, f - 1, g, g));
            }
        ...
        (c.fn.sparkline.tristate = w = e(c.fn.sparkline._base, t, {
          ...
          init: function(a, b, d, e, f) {
            ...
            w._super.init.call(this, a, b, d, e, f),
              (this.regionShapes = {}),
              (this.barWidth = g),
              (this.barSpacing = h),
              (this.totalBarWidth = g + h),
              (this.values = c.map(b, Number)),
              (this.width = e = b.length * g + (b.length - 1) * h),
              c.isArray(d.get("colorMap"))
                ? ((this.colorMapByIndex = d.get("colorMap")),
                  (this.colorMapByValue = null))
                : ((this.colorMapByIndex = null),
                  (this.colorMapByValue = d.get("colorMap")),
                  this.colorMapByValue &&
                    void 0 === this.colorMapByValue.get &&
                    (this.colorMapByValue = new q(this.colorMapByValue))),
              this.initTarget();
        ...
        (c.fn.sparkline.discrete = x = e(c.fn.sparkline._base, t, {
          ...
          init: function(a, d, e, f, g) {
            x._super.init.call(this, a, d, e, f, g),
              (this.regionShapes = {}),
              (this.values = d = c.map(d, Number)),
              (this.min = b.min.apply(b, d)),
              (this.max = b.max.apply(b, d)),
              (this.range = this.max - this.min),
              (this.width = f =
                "auto" === e.get("width") ? 2 * d.length : this.width),
              (this.interval = b.floor(f / d.length)),
              (this.itemWidth = f / d.length),
              void 0 !== e.get("chartRangeMin") &&
                (e.get("chartRangeClip") ||
                  e.get("chartRangeMin") < this.min) &&
                (this.min = e.get("chartRangeMin")),
              void 0 !== e.get("chartRangeMax") &&
                (e.get("chartRangeClip") ||
                  e.get("chartRangeMax") > this.max) &&
                (this.max = e.get("chartRangeMax")),
              this.initTarget(),
              this.target &&
                (this.lineHeight =
                  "auto" === e.get("lineHeight")
        ...
        (c.fn.sparkline.bullet = y = e(c.fn.sparkline._base, {
          ...
          init: function(a, c, d, e, f) {
            var g, h, i;
            y._super.init.call(this, a, c, d, e, f),
              (this.values = c = j(c)),
              (i = c.slice()),
              (i[0] = null === i[0] ? i[2] : i[0]),
              (i[1] = null === c[1] ? i[2] : i[1]),
              (g = b.min.apply(b, c)),
              (h = b.max.apply(b, c)),
              (g = void 0 === d.get("base") ? (g < 0 ? g : 0) : d.get("base")),
              (this.min = g),
              (this.max = h),
              (this.range = h - g),
              (this.shapes = {}),
              (this.valueShapes = {}),
              (this.regiondata = {}),
              (this.width = e = "auto" === d.get("width") ? "4.0em" : e),
              (this.target = this.$el.simpledraw(e, f, d.get("composite"))),
              c.length || (this.disabled = !0),
              this.initTarget();
          },
          getRegion: function(a, b, c) {
            var d = this.target.getShapeAt(a, b, c);
            return void 0 !== d && void 0 !== this.shapes[d]
              ? this.shapes[d]
              : void 0;
          },
          getCurrentRegionFields: function() {
        ...
        (c.fn.sparkline.pie = z = e(c.fn.sparkline._base, {
          ...
          init: function(a, d, e, f, g) {
            var h,
              i = 0;
            if (
              (z._super.init.call(this, a, d, e, f, g),
              (this.shapes = {}),
              (this.valueShapes = {}),
              (this.values = d = c.map(d, Number)),
          ...
          renderSlice: function(a, c) {
            ...
            for (g = o.length, f = 0; f < g; f++) {
              if (
                ((d = q), (e = q), p > 0 && (e = q + n * (o[f] / p)), a === f)
              )
                return (
                  (h = j.get("sliceColors")[f % j.get("sliceColors").length]),
                  c && (h = this.calcHighlightColor(h, j)),
                  i.drawPieSlice(k, k, k - l, d, e, void 0, h)
                );
              q = e;
            }
          },
          render: function() {
            ...
            if (z._super.render.call(this)) {
              for (
                ...
                e[c] &&
                  ((a = this.renderSlice(c).append()),
                  (this.valueShapes[c] = a.id),
                  (this.shapes[a.id] = c));
              d.render();
            }
          }
        ...
        (c.fn.sparkline.box = A = e(c.fn.sparkline._base, {
          type: "box",
          init: function(a, b, d, e, f) {
            A._super.init.call(this, a, b, d, e, f),
              (this.values = c.map(b, Number)),
              (this.width = "auto" === d.get("width") ? "4.0em" : e),
              this.initTarget(),
          ...
          render: function() {
            var a,
              ...
              s = this.canvasHeight,
              t =
                void 0 === q.get("chartRangeMin")
                  ? b.min.apply(b, o)
                  : q.get("chartRangeMin"),
              u =
                void 0 === q.get("chartRangeMax")
                  ? b.max.apply(b, o)
                  : q.get("chartRangeMax"),
              v = 0;
            if (A._super.render.call(this)) {
              if (q.get("raw"))
                q.get("showOutliers") && o.length > 5
                  ? ((c = o[0]),
                    (a = o[1]),
                    (e = o[2]),
                    (f = o[3]),
                ...
                for (a = i = void 0, k = 0; k < p; k++)
                  void 0 === a &&
                    o[k] > e - d * q.get("outlierIQR") &&
                    (a = o[k]),
                    o[k] < g + d * q.get("outlierIQR") && (i = o[k]);
                (c = o[0]), (j = o[p - 1]);
              } else (a = o[0]), (i = o[p - 1]);
              (this.quartiles = [e, f, g]),
                (this.lwhisker = a),
                (this.rwhisker = i),
                (this.loutlier = c),
                (this.routlier = j),
                (m = r / (u - t + 1)),
                q.get("showOutliers") &&
                  ((v = b.ceil(q.get("spotRadius"))),
                  (r -= 2 * b.ceil(q.get("spotRadius"))),
                  (m = r / (u - t + 1)),
                  c < a &&
                    n
                      .drawCircle(
                        ...
                        s / 2,
                        q.get("spotRadius"),
                        q.get("outlierLineColor"),
                        q.get("outlierFillColor")
                      )
                      .append(),
                  j > i &&
                    n
                ...
                n
                  ...
                  .append(),
                q.get("target") &&
                  ((l = b.ceil(q.get("spotRadius"))),
                  n
                    .drawLine(
                      b.round((q.get("target") - t) * m + v),
                      b.round(s / 2 - l),
                      b.round((q.get("target") - t) * m + v),
                      b.round(s / 2 + l),
                      q.get("targetColor")
        ...
        (E = e({
          ...
          _calculatePixelDims: function(a, b, d) {
            ...
            (e = this._pxregex.exec(b)),
              (this.pixelHeight = e ? e[1] : c(d).height()),
              (e = this._pxregex.exec(a)),
              (this.pixelWidth = e ? e[1] : c(d).width());
          },
        ...
        (F = e(E, {
          init: function(b, d, e, f) {
            F._super.init.call(this, b, d, e),
              (this.canvas = a.createElement("canvas")),
              e[0] && (e = e[0]),
              c.data(e, "_jqs_vcanvas", this),
              c(this.canvas).css({
              ...
              this._calculatePixelDims(b, d, this.canvas),
          ...
          _getContext: function(a, b, c) {
            ...
            return (
              void 0 !== a && (d.strokeStyle = a),
              (d.lineWidth = void 0 === c ? 1 : c),
          ...
          _drawShape: function(a, b, c, d, e) {
            var f,
              g,
              h = this._getContext(c, d, e);
            for (
              h.beginPath(),
                h.moveTo(b[0][0] + 0.5, b[0][1] + 0.5),
                f = 1,
                g = b.length;
              f < g;
              f++
            )
              h.lineTo(b[f][0] + 0.5, b[f][1] + 0.5);
            void 0 !== c && h.stroke(),
              void 0 !== d && h.fill(),
              void 0 !== this.targetX &&
                void 0 !== this.targetY &&
        ...
        (G = e(E, {
          ...
          _drawShape: function(a, b, c, d, e) {
            ...
            return (
              ...
              (g =
                void 0 === c
                  ? ' stroked="false" '
                  : ' strokeWeight="' + e + 'px" strokeColor="' + c + '" '),
              (h =
                void 0 === d
                  ? ' filled="false"'
                  : ' fillColor="' + d + '" filled="true" '),
              (i = l[0] === l[l.length - 1] ? "x " : ""),
          ...
          _drawCircle: function(a, b, c, d, e, f, g) {
            ...
            return (
              ...
              (h =
                void 0 === e
                  ? ' stroked="false" '
                  : ' strokeWeight="' + g + 'px" strokeColor="' + e + '" '),
              (i =
                void 0 === f
                  ? ' filled="false"'
          ...
          _drawPieSlice: function(a, c, d, e, f, g, h, i) {
            ...
            if (f === g) return "";
            if (
              (g - f == 2 * b.PI && ((f = 0), (g = 2 * b.PI)),
              (k = c + b.round(b.cos(f) * e)),
              (l = d + b.round(b.sin(f) * e)),
              (m = c + b.round(b.cos(g) * e)),
              (n = d + b.round(b.sin(g) * e)),
              k === m && l === n)
            ) {
              if (g - f < b.PI) return "";
              (k = m = c + e), (l = n = d);
          ...
          replaceWithShapes: function(a, b) {
            var d,
              ...
              g = b.length;
            for (d = 0; d < g; d++)
              f += this["_draw" + b[d].type].apply(this, b[d].args);
            for (e[0].outerHTML = f, d = 1; d < a.length; d++)
              c("#jqsshape" + a[d]).remove();
          },
          insertAfterShape: function(a, b) {
            var d = c("#jqsshape" + a),
              e = this["_draw" + b.type].apply(this, b.args);
